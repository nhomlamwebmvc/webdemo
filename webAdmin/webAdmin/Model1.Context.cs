...
namespace webAdmin
{
    ...
    public partial class QLBanHangEntities : DbContext
    {
        ...
        public virtual ObjectResult<XuatHD_Result> XuatHD(Nullable<int> soHoaDon)
        {
            var soHoaDonParameter = soHoaDon.HasValue ?
                new ObjectParameter("SoHoaDon", soHoaDon) :
                new ObjectParameter("SoHoaDon", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<XuatHD_Result>("XuatHD", soHoaDonParameter);
        }
    }
}
